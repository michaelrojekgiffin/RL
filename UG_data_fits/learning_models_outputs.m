...
function [PE,eO,a_t, EV] = learning_models_outputs(params,o,r,nmodel)
...
for kcond = 1:ncond
    ...
    for ktrial = 1:ntrial
        ...
        PEval               = PE(ktrial,kcond)>0;
        a_t(ktrial+1,kcond)  = a_t(ktrial,kcond) + 20*(lr1*PEval + lr2*(~PEval))*PE(ktrial,kcond);
