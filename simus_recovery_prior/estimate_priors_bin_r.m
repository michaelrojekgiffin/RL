% This function generates the likelihood of each model/paramters, including
% risk

function negLL = estimate_priors_bin_r(params,tr,o)
% comp params
...
utR   = params(4);  % temperature of logit (function of beta0 & beta1) update 
...
EV      = ((endow - offers).^utR).* PA;               % compute EV of the offers given current model
