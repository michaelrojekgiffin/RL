...
%------------------------------------------
cond2learn  = -12; %-[12,9,6,3,0];                        % all the intercepts the player needs to learn
nc          = numel(cond2learn);
...
for k_sim = 1:n_sims
    ...
    [O,D,PE,at] = learning_models_timeseries_MG_2017_09_21([bX,lr1,lr2],[Ra;Rb],n_trial,a0,b0,nmodel);
