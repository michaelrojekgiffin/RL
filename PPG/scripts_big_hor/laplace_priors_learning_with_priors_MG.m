...
function [post, EV, PA, V, pc, PE, risk, risk_pe]=laplace_priors_learning_with_priors_MG(params,o,r,a0,b0,nmodel, lr1_upper_bound, lr2_upper_bound, predprey, R_o)
...
[l, EV, PA, V, pc, PE, risk, risk_pe] = learning_models_estim_with_priors_MG(params,o,r,a0,b0,nmodel, predprey, R_o);
