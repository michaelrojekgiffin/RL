...
% Importantly, v0 and B (which are the parameters that are assigned within
% v0rnd and Brnd) are what the prey predicts are the intercept and slope of
% the predator's threshold, respectively. In other words, these are the two
% parameters that determine which investments will be "accepted" by the
% predator, which together are the intercept and slope of a logistic
% function. I'm getting them from the first round of investments played by
% a very big proportion of our participants
