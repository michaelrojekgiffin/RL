...
%   BASE2DEC(S,B) converts S, text that represents a number in base B, to its 
%   decimal (base 10) equivalent.  B must be an integer
%   between 2 and 36. S must represent a non-negative integer value.
%   If S represents an integer value greater than flintmax, BASE2DEC
%   might not return an exact conversion.
%
