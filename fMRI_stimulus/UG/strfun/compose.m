...
%   character vectors. STR is always a string array.
%
...
% 
%   Example:
%       TXT = string('The quick brown fox jumps');
%       TXT = TXT + '\n' + 'over the lazy dog.';
%       compose(TXT)
%
%       returns
