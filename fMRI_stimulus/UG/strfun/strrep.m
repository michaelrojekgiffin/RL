...
%     scalar string arrays, and same-sized string arrays. If the first
%     input is a string array, STRREP returns a string array. Otherwise,
%     if any inputs are cell arrays, STTREP returns a cell array.
%     Otherwise, STRREP returns a character vector.
%
