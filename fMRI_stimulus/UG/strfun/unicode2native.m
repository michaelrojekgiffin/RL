...
%   BYTES = UNICODE2NATIVE(UNICODESTR) converts a character vector of Unicode
%   character representations, UNICODESTR, to the user default encoding,
...
%   ENCODING must be the empty character vector ('') or a name or alias
%   for an encoding scheme. Some examples are 'UTF-8', 'latin1', 'US-ASCII', 
%   and 'Shift_JIS'. If ENCODING is unspecified or is empty, MATLAB's default 
