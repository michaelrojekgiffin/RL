...
%                   Amended by Michael Giffin December 2017
%                   Changed movement from mouse to keys and added ticks to slider 
...
%         x = x - (globalRect(3)*(1-scalaLength))/4;
        x = x - round(length(scaleRange)/4);
        fprintf('key has been pressed %d\n', x);
