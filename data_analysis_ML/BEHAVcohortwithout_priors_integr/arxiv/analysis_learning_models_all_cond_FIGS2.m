...
for k_param = 1:5
    ...
    hold on
    for k_sub = 1:nImp
        plot([.8 2.2],[LEARN_parametersLPP(sImp(k_sub),k_param,Nmodel,2) LEARN_parametersLPP(sImp(k_sub),k_param,Nmodel,1)],...
            '-k','LineWidth',.5,'Color',.7*[1,1,1])
    end
    plot(.8*ones(nImp,1),squeeze(LEARN_parametersLPP(Imp,k_param,Nmodel,2)),'sq',...
        'LineStyle','none',...
        'MarkerEdgeColor',.5.*[1,1,1],...
        'MarkerFaceColor',.6.*[1,1,1])
    plot(2.2*ones(nImp,1),squeeze(LEARN_parametersLPP(Imp,k_param,Nmodel,1)),'sq',...
        'LineStyle','none',...
        'MarkerEdgeColor',.7.*[1,1,1],...
        'MarkerFaceColor',[1,1,1])
    
    errorbar([1.25 1.75],...
        [squeeze(mean(LEARN_parametersLPP(Imp,k_param,Nmodel,2),1)) squeeze(mean(LEARN_parametersLPP(Imp,k_param,Nmodel,1),1))],...
        [squeeze(std(LEARN_parametersLPP(Imp,k_param,Nmodel,2),0,1))./sqrt(nImp) squeeze(std(LEARN_parametersLPP(Imp,k_param,Nmodel,1),0,1))./sqrt(nImp)],...
        '-k','LineWidth',1,'Color',.2*[1,1,1])
    plot(1.25,squeeze(mean(LEARN_parametersLPP(Imp,k_param,Nmodel,2),1)),'sq',...
        'LineStyle','none',...
        'LineWidth',1,...
        'MarkerEdgeColor',[0,0,0],...
        'MarkerFaceColor',.0.*[1,1,1])
    plot(1.75,squeeze(mean(LEARN_parametersLPP(Imp,k_param,Nmodel,1),1)),'sq',...
        'LineStyle','none',...
        'LineWidth',1,...
        'MarkerEdgeColor',[0,0,0],...
        'MarkerFaceColor',[1,1,1])
    ...
    for k_sub = 1:nExp
        plot(2+[.8 2.2],[LEARN_parametersLPP(sExp(k_sub),k_param,Nmodel,2) LEARN_parametersLPP(sExp(k_sub),k_param,Nmodel,1)],...
            '-k','LineWidth',.5,'Color',.7*[1,1,1])
    end
    plot(2+.8*ones(nExp,1),squeeze(LEARN_parametersLPP(Exp,k_param,Nmodel,2)),'o',...
        'LineStyle','none',...
        'MarkerEdgeColor',.5.*[1,1,1],...
        'MarkerFaceColor',.6.*[1,1,1])
    plot(2+2.2*ones(nExp,1),squeeze(LEARN_parametersLPP(Exp,k_param,Nmodel,1)),'o',...
        'LineStyle','none',...
        'MarkerEdgeColor',.7.*[1,1,1],...
        'MarkerFaceColor',[1,1,1])
    
    errorbar(2+[1.25 1.75],...
        [squeeze(mean(LEARN_parametersLPP(Exp,k_param,Nmodel,2),1)) squeeze(mean(LEARN_parametersLPP(Exp,k_param,Nmodel,1),1))],...
        [squeeze(std(LEARN_parametersLPP(Exp,k_param,Nmodel,2),0,1))./sqrt(nExp) squeeze(std(LEARN_parametersLPP(Exp,k_param,Nmodel,1),0,1))./sqrt(nExp)],...
        '-k','LineWidth',1,'Color',.2*[1,1,1])
    plot(2+1.25,squeeze(mean(LEARN_parametersLPP(Exp,k_param,Nmodel,2),1)),'o',...
        'LineStyle','none',...
        'LineWidth',1,...
        'MarkerEdgeColor',[0,0,0],...
        'MarkerFaceColor',.0.*[1,1,1])
    plot(2+1.75,squeeze(mean(LEARN_parametersLPP(Exp,k_param,Nmodel,1),1)),'o',...
        'LineStyle','none',...
        'LineWidth',1,...
        'MarkerEdgeColor',[0,0,0],...
        'MarkerFaceColor',[1,1,1])
...
for kSoc = 1:2
    ...
    for kImpexp = 1:2
        ...
        hX = xlabel('param');
        hY = ylabel('Value');
        hTTL = title(strcat(['Social = ',num2str(kSoc-1) '; ImpExp == ',num2str(kImpexp-1)]));
        set([hX,hY,hTTL],'FontName','Arial',...
            'FontSize',10)
    end
end
