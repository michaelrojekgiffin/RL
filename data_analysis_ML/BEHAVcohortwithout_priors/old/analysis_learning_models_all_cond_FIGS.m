...
%%
      ...
      plot(2.2*ones(nExp,1),squeeze(LEARN_parametersLPP(Exp,k_param,Nmodel,1)),'d',...
          'LineStyle','none',...
          'MarkerEdgeColor',.5.*[1,1,1],...
          'MarkerFaceColor',.8.*[1,1,1])
      
            errorbar([1.25 1.75],...
          [squeeze(mean(LEARN_parametersLPP(Imp,k_param,Nmodel,2),1)) squeeze(mean(LEARN_parametersLPP(Exp,k_param,Nmodel,1),1))],...
          [squeeze(std(LEARN_parametersLPP(Imp,k_param,Nmodel,2),0,1))./sqrt(nImp) squeeze(std(LEARN_parametersLPP(Exp,k_param,Nmodel,1),0,1))./sqrt(nExp)],...
              '-k','LineWidth',1,'Color',.2*[1,1,1])
      ...
      plot(1.75,squeeze(mean(LEARN_parametersLPP(Exp,k_param,Nmodel,1),1)),'d',...
          'LineStyle','none',...
          'LineWidth',1,...
          'MarkerEdgeColor',[0,0,0],...
          'MarkerFaceColor',.5.*[1,1,1])
